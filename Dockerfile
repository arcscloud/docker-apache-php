...
RUN	\
	...
	&& apt-get update \
    && apt-get install -y curl apache2 libapache2-mod-php php-dev php-cli php-readline php-mbstring php-zip php-intl php-xml php-json php-curl php-gd php-pgsql php-mysql php-pear vim \
    # Apache settings
